...
package com.frca.purtges.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://purtges.appspot.com/_ah/api/";
  ...
  public class GetUser extends UserendpointRequest<com.frca.purtges.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Integer id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.frca.purtges.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link com.frca.purtges.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.frca.purtges.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.frca.purtges.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.frca.purtges.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.frca.purtges.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.frca.purtges.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.frca.purtges.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public RemoveUser removeUser(java.lang.Integer id) throws java.io.IOException {
    RemoveUser result = new RemoveUser(id);
    initialize(result);
    return result;
  }

  public class RemoveUser extends UserendpointRequest<com.frca.purtges.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected RemoveUser(java.lang.Integer id) {
      super(Userendpoint.this, "DELETE", REST_PATH, null, com.frca.purtges.userendpoint.model.User.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
    ...
    public RemoveUser setId(java.lang.Integer id) {
      this.id = id;
      return this;
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.frca.purtges.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.frca.purtges.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.frca.purtges.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.frca.purtges.userendpoint.model.User.class);
    }
