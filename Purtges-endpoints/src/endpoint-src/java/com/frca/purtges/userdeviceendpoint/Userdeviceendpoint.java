 ...
 * on 2013-07-08 at 11:12:16 UTC 
 * Modify at your own risk.
 */

package com.frca.purtges.userdeviceendpoint;
...
public class Userdeviceendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUserDevice extends UserdeviceendpointRequest<com.frca.purtges.userdeviceendpoint.model.UserDevice> {
    ...
    protected GetUserDevice(java.lang.String id) {
      super(Userdeviceendpoint.this, "GET", REST_PATH, null, com.frca.purtges.userdeviceendpoint.model.UserDevice.class);
  ...
  public class InsertUserDevice extends UserdeviceendpointRequest<com.frca.purtges.userdeviceendpoint.model.UserDevice> {
    ...
    protected InsertUserDevice(java.lang.String registrationId) {
      super(Userdeviceendpoint.this, "POST", REST_PATH, null, com.frca.purtges.userdeviceendpoint.model.UserDevice.class);
  ...
  public class ListUserDevice extends UserdeviceendpointRequest<com.frca.purtges.userdeviceendpoint.model.CollectionResponseUserDevice> {
    ...
    protected ListUserDevice() {
      super(Userdeviceendpoint.this, "GET", REST_PATH, null, com.frca.purtges.userdeviceendpoint.model.CollectionResponseUserDevice.class);
    }
  ...
  public class RemoveUserDevice extends UserdeviceendpointRequest<com.frca.purtges.userdeviceendpoint.model.UserDevice> {
    ...
    protected RemoveUserDevice(java.lang.String id) {
      super(Userdeviceendpoint.this, "DELETE", REST_PATH, null, com.frca.purtges.userdeviceendpoint.model.UserDevice.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * operation.
   *
   * @param content the {@link com.frca.purtges.userdeviceendpoint.model.UserDevice}
   * @return the request
   */
  public UpdateUserDevice updateUserDevice(com.frca.purtges.userdeviceendpoint.model.UserDevice content) throws java.io.IOException {
    UpdateUserDevice result = new UpdateUserDevice(content);
    initialize(result);
    return result;
  }

  public class UpdateUserDevice extends UserdeviceendpointRequest<com.frca.purtges.userdeviceendpoint.model.UserDevice> {
     ...
     * @since 1.13
     */
    protected UpdateUserDevice(com.frca.purtges.userdeviceendpoint.model.UserDevice content) {
      super(Userdeviceendpoint.this, "PUT", REST_PATH, content, com.frca.purtges.userdeviceendpoint.model.UserDevice.class);
    }
